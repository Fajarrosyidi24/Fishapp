...
@section('title')
    <title>Detail Pesanan Seafood</title>
    <style>
        .content-container {
            display: flex;
...
<div class="container mt-5">
    <div class="card shadow-sm border-0 rounded">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0">Detail Pesanan Seafood</h4>
            <div class="resi-container">
                <span style="display: flex; justify-content: flex-end;">Nomor Resi : 02479954612</span>
        ...
        <div class="content-container">
            <div class="class-body">
                <table>
                    <tbody>
                        <tr>
                            <th class="large-font">Nama Pembeli</th>
                            <td class="large-font">Pratama Zidan</td>
                        </tr>
                        <tr>
                            <th class="large-font">Jumlah Pesanan</th>
                            <td class="large-font">1</td>
                        </tr>
                        <tr>
                            <th class="large-font">Total Harga Pesanan</th>
                            <td class="large-font">Rp. 10.000,-</td>
                        </tr>
                        <tr>
                            <th class="large-font">Tanggal Pemesanan</th>
                            <td class="large-font">9-9-2024</td>
                        </tr>
                        <tr>
                            <th class="large-font">Alamat Pengiriman</th>
                            <td class="large-font">Dusun Maron, RT/RW.007/002, Desa Genteng Kulon, Kecamatan Genteng, Kabupaten Banyuwangi</td>
                        </tr>
                        <tr>
                            <th class="large-font">Metode Pembayaran</th>
                            <td class="large-font">Transfer Bank</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="large-font">Nomor Telpon Pembeli</th>
            ...
            <div class="image-container">
                <img src="{{ asset('storage/fotoseafood/735e4294-8d2e-4d9e-88db-be31eb232df5_1731049380_download.jpg') }}" alt="Foto Seafood" class="rounded img-thumbnail">
            </div>
        </div>
