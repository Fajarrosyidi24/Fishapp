        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-2 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item bg-light text-center">
                    ...
                    <div class="p-4">
                        <h6 class="mb-0">Mohammad Fajar Rosyidi</h6>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item bg-light text-center">
                    ...
                    <div class="p-4">
                        <h6 class="mb-0">Mohamad Rizki Ramadhan</h6>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item bg-light text-center">
                    ...
                    <div class="p-4">
                        <h6 class="mb-0">Mohammad Zidan Caesar Pratama</h6>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item bg-light text-center">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="img/Gambar WhatsApp 2024-06-03 pukul 14.26.33_9352870c.jpg" alt="">
                    </div>
                    <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
                        <div class="bg-light d-flex justify-content-center pt-2 px-1">
                            <a class="btn btn-sm-square btn-primary mx-1" href="https://github.com/MochRizqiYassar"><i class="bi bi-github"></i></a>
                            <a class="btn btn-sm-square btn-primary mx-1" href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=kikioryassar.2003@gmail.com"><i class="bi bi-google"></i></a>
                            <a class="btn btn-sm-square btn-primary mx-1" href="https://www.instagram.com/ris_ki1803/"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="p-4">
                        <h6 class="mb-0">Moch. Rizqi Yassar</h6>
                        <small style="color: black">System Analyst</small>
                    </div>
                </div>
            </div>
        </div>
