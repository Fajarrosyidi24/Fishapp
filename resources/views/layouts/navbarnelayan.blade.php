...
<nav class="sb-topnav navbar navbar-expand navbar-light "
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" style="{{ request()->routeIs('nelayan.pengaturan') ? 'color: white;' : '' }} {{ request()->routeIs('nelayan.profile') ? 'color: white;' : '' }}"
                ...
                @endif
                {{ Auth::guard('nelayan')->user()->name }}</a>
