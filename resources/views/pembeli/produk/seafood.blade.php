            ...
            <div class="col-lg-10 text-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a class="text-white" href="{{ route('pembeli.produk.seafood') }}">Seafood</a>
                        </li>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="hargaSeafood" value="{{ $se->harga->harga }}" readonly>
                            </div>
                        </form>
                    </div>
