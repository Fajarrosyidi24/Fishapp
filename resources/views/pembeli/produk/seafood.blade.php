                ...
                <div class="col">
                    <a href="{{ route('beliseafood', ['kode_seafood' => $se->kode_seafood]) }}"
                        ...
                        <div class="card h-100 shadow-sm">
                            <img src="{{ asset('storage/fotoseafood/' . $se->foto) }}" class="card-img-top"
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="progress" style="height: 5px;"> <!-- Ukuran progress bar -->
                                        ...
                                        <div class="progress-bar bg-success" role="progressbar"
                                            style="width: {{ $percentage }}%;" aria-valuenow="{{ $se->jumlah_terjual }}"
                                            aria-valuemin="0" aria-valuemax="{{ $se->jumlah }}">
                                        </div>
                                    </div>
                                </div>
                                <p class="card-text fw-bold mb-1">Rp {{ number_format($se->harga->harga, 0, ',', '.') }} /KG
                                </p>
